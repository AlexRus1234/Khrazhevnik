...
// запроса пишется с итоговым статусом (аудит 2026-08-27). Content-Type
// задаётся allowlist'ом на обоих классах путей — repo-объекты по
// расширению (repoContentType), upstream-ответы прокси через
// proxyContentType (сессия 78); nosniff — второй слой, запрещающий
// переинтерпретацию объявленного типа на всех ответах роутера
// (аудит 2026-08-30).
