...
// кеша (cache_stats). Запросы — копия sqlite-адаптера; upsert —
// ON DUPLICATE KEY UPDATE через dbtalk.MariaDB. Флаш/загрузка
// снапшота — сессия 96.
...
func statsUpsertSQL() string {
	return dbtalk.Upsert(dbtalk.MariaDB{}, "cache_stats", "ecosystem",
