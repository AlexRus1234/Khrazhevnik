...
// извлечённые из repomd.xml при Enumerate (sync зеркала). Прокси-запросы
...
// Content-Length. Дубликат из apt/apk: mod→mod запрещён, адаптеры
// самодостаточны.
...
// repomd целиком, прежние знания устаревать не должны.
