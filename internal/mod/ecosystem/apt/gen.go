...
//
// Имена файлов-индексов в storage — lowercase: v1-конвенция
// «публикованные ключи lowercase» (upload-ветка лоуэркейсит путь,
// см. docs/func/ru/personal-repos.md). Сессия 19 разрешила верхний
// регистр в ValidateKey для case-чувствительных путей прокси-кеша
// (cache/apt/<id>/pool/Foo.deb), но конвенцию личных репо не меняем:
// клиенты apt-get просят /Packages//Release/ (заглавные), публичный
// роутер :29202 лоуэркейсит запрос перед lookup'ом — совпадение
// ключей гарантировано.
const (
	repoDist       = "stable"
	suite          = "stable"
	repoComponent  = "main"
