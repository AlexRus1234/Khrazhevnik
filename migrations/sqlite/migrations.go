...
// Package migrations — SQL-миграции sqlite-каталога (диалект-специфичные
// каталоги migrations/<driver>/ — docs/SPECIFICATION.md §БД). FS —
// package-level var: go:embed иначе не работает, а значение
