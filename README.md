...
Направления развития после релиза v1.0.0 (решение владельца от
2026-09-05; там же в [docs/ROADMAP.md](docs/ROADMAP.md) — eviction
старых версий и прочие пост-v1 вопросы). Приоритет: сначала XBPS и
